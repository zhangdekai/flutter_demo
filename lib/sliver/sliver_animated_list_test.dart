    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: <Widget>[
          ...
          // SliverVisibility(sliver: sliver)
          // SliverToBoxAdapter()
          // SliverSafeArea(sliver: sliver)
          // SliverRecorderableList
          ...
          // SliverChildListDelegate(children)Delegate
          // SliverAnimatedOpacity(opacity: opacity, duration: duration)
        ],
      ),
    );
  }
