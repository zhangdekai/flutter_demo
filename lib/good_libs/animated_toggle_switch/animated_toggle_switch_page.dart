...
final toggleSwitchUrl = Uri.parse('https://pub.flutter-io.cn/packages/toggle_switch');
final liteRollingSwitchUrl = Uri.parse('https://pub.flutter-io.cn/packages/lite_rolling_switch');
final crazySwitchUrl = Uri.parse('https://github.com/pedromassango/crazy-switch');
final loadSwitchUrl = Uri.parse('https://pub.flutter-io.cn/packages/load_switch');

class AnimatedToggleSwitchPage extends StatefulWidget {
  const AnimatedToggleSwitchPage({super.key, required this.title});
